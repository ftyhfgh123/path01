    ...
    namespace offsets
    {
        // buttons
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        const long IN_ATTACK = 0x07420848;              // Buttons.in_attack
        // core
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        const long REGION = 0x140000000;
        const long LEVEL = 0x16f51c0;                   // Miscellaneous.LevelName
        const long LOCAL_PLAYER = 0x21d1738;            // Miscellaneous.LocalPlayer
        const long ENTITY_LIST = 0x1e213f8;             // Miscellaneous.cl_entitylist
        const long HIGHLIGHT_SETTINGS = 0xB5F7620; //0xB5F8620; //0xb5f9620;      // Miscellaneous.?
        const long HIGHLIGHT_TYPE_SIZE = 0x28;          // Miscellaneous.?   CBaseTempEntity
        // entity
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        const long LOCAL_ORIGIN = 0x0188;               // [DataMap.CBaseViewModel]    -> m_localOrigin C_BaseEntity.m_localOrigin
        // player
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        const long OFFSET_WEAPON_SPEED = (0x19c8 + 0x04d4);        // WeaponSettingsMeta.base + projectile_launch_speed
        const long OFFSET_WEAPON_SEMIAUTO = (0x19c8 + 0x018c);     // WeaponSettingsMeta.base + is_semi_auto
    }
