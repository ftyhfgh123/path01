...
const long LOCAL_PLAYER = (0x02139480 + 0x8); // [Miscellaneous] -> LocalPlayer AVC_GameMovement + 0x8
...
const long LAST_VISIBLE_TIME = 0x1A80; // [Miscellaneous] -> CPlayer!lastVisibleTime 1st offset from dump
